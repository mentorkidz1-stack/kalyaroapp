    ...
    <div className="min-h-screen bg-bg">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="text-center mb-12">
          <h1 className="font-display font-extrabold text-3xl md:text-4xl text-ink leading-tight mb-4">
            L'apprentissage adaptatif, pensé pour le Bénin
          </h1>
          <p className="text-base text-ink-soft max-w-xl mx-auto mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-12">
          {PILIERS.map((p) => (
            <Card key={p.titre}>
              ...
              <div className="font-display font-bold text-sm text-ink mb-2">{p.titre}</div>
              <p className="text-xs text-ink-soft leading-relaxed">{p.texte}</p>
            </Card>
          ))}
        </div>

        <Card className="text-center">
          <div className="font-display font-bold text-base text-ink mb-2">
